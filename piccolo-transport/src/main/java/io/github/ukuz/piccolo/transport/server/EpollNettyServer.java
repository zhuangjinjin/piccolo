 ...
 * @author ukuz90
 */
public abstract class EpollNettyServer extends NettyServer {

    private String id;
    private InetSocketAddress address;

    public EpollNettyServer(String id, InetSocketAddress address) {
        this.id = id;
    ...
    protected EventLoopGroup getWorkerThreadPool() {
        EpollEventLoopGroup workerGroup = new EpollEventLoopGroup(getWorkerThreadNum(), getWorkerThreadFactory());
